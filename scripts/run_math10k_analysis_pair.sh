...
"$PRISM_PYTHON" train_eval.py --config configs/math10k_paper.json --method baseline "$@" --telemetry_mode research_raw --allow_non_private_telemetry
"$PRISM_PYTHON" train_eval.py --config configs/math10k_paper.json --method slaclip "$@" --telemetry_mode research_raw --allow_non_private_telemetry
